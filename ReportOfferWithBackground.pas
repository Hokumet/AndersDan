unit ReportOfferWithBackground;
...
type
  TfrmReportOfferWithBackground = class(TForm)
...
var
  frmReportOfferWithBackground: TfrmReportOfferWithBackground;
...
constructor TfrmReportOfferWithBackground.Create(Owner: TComponent; ID: Integer;
...
procedure TfrmReportOfferWithBackground.exportToPdf(ExportDir: String);
...
procedure TfrmReportOfferWithBackground.frxreportGetValue(const VarName: string;
  var Value: Variant);
